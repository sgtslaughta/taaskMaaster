...
class TestLogger:
    ...
    def __init__(self, name: str = "taaskmaaster_tests", log_dir: str = "logs"):
        ...
        # Log initialization
        self.logger.info("Test logger initialized", extra={
    ...
    def log_command_execution(self, command: list, success: bool, 
    ...
    def log_docker_event(self, event: str, details: dict):
        ...
        self.logger.info(f"Docker event: {event}", extra={
            "docker_event": event,
            **details,
            "event": "docker_event"
        })
    ...
    def log_summary(self, total_tests: int, passed: int, failed: int, 
                   skipped: int, total_duration: float):
        """Log test summary."""
        success_rate = (passed / total_tests * 100) if total_tests > 0 else 0
        
        self.logger.info("Test run summary", extra={
...
def log_test_event(event: str, **kwargs):
    ...
    logger.logger.info(f"Test event: {event}", extra={
        "event": event,
        **kwargs
    })
